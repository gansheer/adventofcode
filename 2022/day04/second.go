...
func inBoth(data entryData) bool {
	fmt.Println(data.first_1, "|", data.first_2, "<>", data.second_1, "|", data.second_2)
	secondStartsInfirst := data.first_1 <= data.second_1 && data.first_2 >= data.second_1
	firstStartsInSecond := data.second_1 <= data.first_1 && data.second_2 >= data.first_1
	fmt.Println("secondStartsInfirst", secondStartsInfirst, "firstStartsInSecond", firstStartsInSecond)
	return secondStartsInfirst || firstStartsInSecond
}
